      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-12 md:py-16">
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://www.instagram.com/utaustin.korea" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-burnt-orange transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.linkedin.com/in/ut-austin-korean-alumni-association/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-burnt-orange transition-colors" aria-label="LinkedIn">
