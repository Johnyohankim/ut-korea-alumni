...
export default function Footer() {
  ...
  return (
    <footer className="bg-charcoal text-white/80">
      ...
      <div className="h-1 bg-gradient-to-r from-burnt-orange via-gold to-burnt-orange" />
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              <svg viewBox="0 0 40 28" className="w-8 h-6 fill-burnt-orange">
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/40">
            &copy; {new Date().getFullYear()} UT Austin Korea Alumni Association. {t('footer.rights')}
          </p>
          <div className="flex items-center gap-4">
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-burnt-orange transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-burnt-orange transition-colors" aria-label="LinkedIn">
